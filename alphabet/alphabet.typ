...
#align(center)[
  ...
  #table(
    ...
    // 'G' letter
    , [G g], [\[dʒɪ\]], [джи], [\[g\]#h(10pt)\[dʒ\]], [г дж], [\[ʒ\]#h(10pt)\[ŋ\] = ng]

    // 'H' letter
    , [H h], [\[eɪtʃ\]], [эйч], [\[h\]], [х], [\[- \] = wh]

    // 'I' letter
    , [I i], [\[aɪ\]], [ай], [\[aɪ\]#h(10pt)\[ɪ\]], [ай и], [\[əː\]#h(10pt)\[aɪə\]]
    ...
    // 'O' letter
    , [O o], [\[ou\]], [оу], [\[ou\]#h(10pt)\[ɔ\]], [о оу], [\[ɔː\]#h(10pt)\[əː\]#h(10pt)\[ʌ\]]
    ...
    // 'W' letter
    , [W w], [\[’dʌbljuː\]], [#text(size: 10pt, "дабл ю")], [\[w\]], [ви], [\[- \] = wr]

    // 'X' letter
    , [X x], [\[eks\]], [икс], [\[ks\]#h(10pt)\[gz\]], [кс гз], []

    // 'Y' letter
    , [Y y], [\[waɪ\]], [вай], [\[j\]#h(10pt)\[aɪ\]#h(10pt)\[ɪ\]], [й ай и], [\[aɪə\]]
